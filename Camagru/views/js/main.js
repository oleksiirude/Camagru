let main_uri = document.documentURI.substring(0, 38); // for unit
let tail_main_uri = document.documentURI.substr(38);
main_uri += tail_main_uri.replace(/\/{2,}/, '/');

if (main_uri === 'http://camagru.us-east-2.elasticbeanstalk.com/') {
	window.scrollTo(0, 0);
